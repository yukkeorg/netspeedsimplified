...
Prefs.prototype = {
    ...
    init: function(schema) {
        this.settings = new Convenience.getSettings(schema);
    },
    buildPrefsWidget: function()
    {
        ...
        function vBoxSpinBtn(getDouble, whichHbox, getLbl = "", getTooTip = "", lower, upper,
                             stpInc = 1, digs = 0, nume = true, page_increment = 1, page_size = 0,
                             clmrate = 1) {
            ...
            whichSpinBtn = new Gtk.SpinButton({
                adjustment: new Gtk.Adjustment({
                    lower: lower, upper: upper, step_increment: stpInc,
